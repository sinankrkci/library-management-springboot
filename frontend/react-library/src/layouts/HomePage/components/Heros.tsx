          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                be able to provide the content for you.
              </p>
        ...
        <div className="row g-0">
          ...
          >
            <div className="ml-2">
              ...
              <p className="lead">
                Try to check in daily as your colleciton is always changing! We
                work nonstop to provide the most accurate book selection
                possible for oue Luv 2 Read students! We are diligent about our
                book selection and our books are always
